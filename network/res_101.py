...
class resnet_101(nn.Module):
    def __init__(self, in_channel=64, num_classes=10):
        ...
        self.layer1 = self.make_layer(Bottleneck, in_channel, 3, stride=1)
        self.layer2 = self.make_layer(Bottleneck, in_channel * 2, 4, stride=2)
        self.layer3 = self.make_layer(Bottleneck, in_channel * 4, 23, stride=2)
        self.layer4 = self.make_layer(Bottleneck, in_channel * 8, 3, stride=2)
